...
if ( ! function_exists( 'galaxis_register_required_plugins' ) ) {
	/**
	 * Register the required plugins for this theme.
	 * This function is hooked into `tgmpa_register`, which is fired on the WP `init` action on priority 10.
	 */
	function galaxis_register_required_plugins() {
		/*
		...
		*/
		$config = array(
			'id'           => 'galaxis',               // Unique ID for hashing notices for multiple instances of TGMPA.
...
add_action( 'tgmpa_register', 'galaxis_register_required_plugins' );
