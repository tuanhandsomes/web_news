...
if ( ! function_exists( 'newspaperup_sanitize_checkbox' ) ) :
     ...
     */
    function newspaperup_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'newspaperup_sanitize_positive_integer' ) ) :
     ...
     */
    function newspaperup_sanitize_positive_integer( $input, $setting ) {
...
if ( ! function_exists( 'newspaperup_sanitize_number_range' ) ) :
     ...
     */
    function newspaperup_sanitize_number_range( $input, $setting ) {
...
if ( ! function_exists( 'newspaperup_sanitize_dropdown_pages' ) ) :
     ...
     */
    function newspaperup_sanitize_dropdown_pages( $page_id, $setting ) {
...
if ( ! function_exists( 'newspaperup_sanitize_image' ) ) :
     ...
     */
    function newspaperup_sanitize_image( $image, $setting ) {
...
if ( ! function_exists( 'newspaperup_sanitize_radio' ) ) :
function newspaperup_sanitize_radio( $val, $setting ) {
...
if ( ! function_exists( 'newspaperup_text_sanitization' ) ) :
	 ...
	 */
	if ( ! function_exists( 'newspaperup_text_sanitization' ) ) {
		function newspaperup_text_sanitization( $input ) {
 ...
 * @return string	Sanitized input
 */
if ( ! function_exists( 'newspaperup_sanitize_alpha_color' ) ) :
    function newspaperup_sanitize_alpha_color( $value ) {
