...
/**
 * Class Newspaperup_Customize_Alpha_Color_Control
 */
class Newspaperup_Customize_Alpha_Color_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script(
			'newspaperup_alpha-color-picker',
