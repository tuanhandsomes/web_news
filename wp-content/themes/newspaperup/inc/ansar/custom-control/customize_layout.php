...
function newspaperup_slider_layout_manager_customizer( $wp_customize ){

	class Newspaperup_layout_Customize_Control extends WP_Customize_Control {	
		...
		public function render_content() {
			...
			<h3><?php _e('Enable','newspaperup'); ?></h3>
			...
			<h3><?php _e('Disable','newspaperup'); ?></h3> 
...
add_action( 'customize_register', 'newspaperup_slider_layout_manager_customizer' );